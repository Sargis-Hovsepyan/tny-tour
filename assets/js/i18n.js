...
(function () {
  ...
  var AM_RAW = {
    ...
    ": two on arrival (26–27 October) and three more after Transylvania (30 October–1 November). A 3-star superior hotel.": "՝ երկուսը ժամանելիս (հոկտեմբերի 26–27) և երեքը՝ Տրանսիլվանիայից հետո (հոկտեմբերի 30 – նոյեմբերի 1)։ 3 աստղանի բարձրակարգ հյուրանոց։",
    ...
    "(28–29 October).": "(հոկտեմբերի 28–29)։",
    ...
    "Set in District 1 between Gara de Nord and the Old Town. The hotel has a restaurant, gym, lobby bar and underground parking.": "Գտնվում է 1-ին շրջանում՝ Gara de Nord-ի և Հին քաղաքի միջև։ Հյուրանոցն ունի ռեստորան, մարզասրահ, լոբբի-բար և ստորգետնյա կայանատեղ։",
    "The guesthouse and location": "Հյուրատունը և տեղադիրքը",
    "A family-run guesthouse of just eight rooms in Centrul Nou, a short walk from Council Square. The building has a shared lounge, a quiet terrace and a kitchen for the group.": "Ընտանեկան հյուրատուն՝ ընդամենը ութ սենյակով Centrul Nou-ում, մի քանի քայլ Խորհրդի հրապարակից։ Շենքն ունի ընդհանուր հանգստի սրահ, հանգիստ տեռաս և խոհանոց՝ խմբի համար։",
    "The rooms": "Սենյակները",
    "Modern rooms with exposed concrete ceilings, hand-drawn Romanian folk patterns and warm purple accents. Each room has air conditioning, a flat-screen TV, an in-room safe and a private bathroom with free toiletries.": "Ղամանակակից սենյակներ՝ բաց բետոնե առաստաղներով, ձեռքով նկարված ռումինական ժողովրդական նախշերով և տաք մանուշակագույն շեշտադրումներով։ Յուրաքանչյուր սենյակ ունի օդորակիչ, հարթ էկրանով հեռուստացույց, սենյակային սեյֆ և առանձին սանհանգույց՝ անվճար հիգիենայի պարագաներով։",
