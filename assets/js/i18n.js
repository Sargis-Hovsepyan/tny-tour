...
(function () {
  ...
  var AM_RAW = {
    ...
    "Both properties are central, personally vetted, and include daily breakfast.": "Երկու կացարաններն էլ կենտրոնական են, անձամբ ստուգված և ներառում են ամենօրյա նախաճաշ։",
    "5 nights": "5 գիշեր",
    "2 nights": "2 գիշեր",
    ...
    "A family-run guesthouse of eight rooms, a short walk from Council Square. Quiet terrace and breakfast every morning.": "Ընտանեկան հյուրատուն՝ ութ սենյակով, մի քանի քայլ Խորհրդի հրապարակից։ Հանգիստ տեռաս և նախաճաշ ամեն առավոտ։",
    ...
    "Your child's safety and your peace of mind are our top priority.": "Անվտանգությունն ու ծնողների հանգստությունը մեր առաջնահերթությունն են։",
