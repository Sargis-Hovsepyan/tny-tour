...
(function () {
  ...
  var AM_RAW = {
    ...
    "in between (28–29 October).": "հենց դրանց միջև (հոկտեմբերի 28–29)։",
    ...
    "(28–29 October). A recently renovated, family-run guesthouse of just eight rooms, rated 9.6 by guests on Booking.com. From here you explore Bran Castle, Râșnov Fortress and Brașov's medieval old town.": "(հոկտեմբերի 28–29)։ Վերջերս նորոգված, ընտանեկան հյուրատուն՝ ընդամենը ութ սենյակով, Booking.com-ում հյուրերի կողմից գնահատված 9.6։ Այստեղից կբացահայտեք Բրանի ամրոցը, Ռըշնովի բերդը և Բրաշովի միջնադարյան հին քաղաքը։",
